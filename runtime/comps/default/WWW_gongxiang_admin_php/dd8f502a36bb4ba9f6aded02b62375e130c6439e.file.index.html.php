<?php /* Smarty version Smarty-3.1.8, created on 2016-02-03 14:29:13
         compiled from "./admin/views/default\notice\index.html" */ ?>
<?php /*%%SmartyHeaderCode:3144756b19e3992a361-47893013%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dd8f502a36bb4ba9f6aded02b62375e130c6439e' => 
    array (
  ...
  'nocache_hash' => '3144756b19e3992a361-47893013',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56b19e39a437a2_01680462',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56b19e39a437a2_01680462')) {function content_56b19e39a437a2_01680462($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\phpStudy\\WWW\\gongxiang\\php\\libs\\plugins\\modifier.date_format.php';
?><?php echo $_smarty_tpl->getSubTemplate ("public/head.html", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

	<div id="main">
		<div class="head-dark-box">
			<div class="tit">基本管理 > 公告管理 > 管理公告</div>
		</div>
...
/order" >
			<div class="msg-box">
				<ul class="viewmess">
					<li class="dark-row">
						<span class="list_width width_font" style="width:450px;">公告标题</span>
...
$_smarty_tpl->tpl_vars['smarty']->value['section']['doc']['loop'] = is_array($_loop=$_smarty_tpl->tpl_vars['notices']->value) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>	
					<li class="<?php if (!(1 & $_smarty_tpl->getVariable('smarty')->value['section']['doc']['index'])){?>light-row<?php }else{ ?>dark-row<?php }?>" style="<?php if ($_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['display']==0){?>background:#FAECBA;<?php }?>padding-top:2px; padding-bottom:2px">
						<span class="list_width" style="width:450px"><input type="text" name="ord[]" style="width:20px" maxlength="3" value="<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['ord'];?>
">&nbsp;<a style="color:#<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['color'];?>
" target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['root']->value;?>
/index.php/index/notice/id/<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['id'];?>
"><?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['title'];?>
</a></span>
						<input type="hidden" name="ids[]" value="<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['id'];?>
">
						<span class="list_width" style="width:100px;<?php if ($_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['starttime']>=time()){?>color:blue;<?php }?>"><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['starttime'],"%Y-%m-%d");?>
</span>
						<span class="list_width <?php if ($_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['endtime']<=time()&&$_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['endtime']!='0'){?>red_font<?php }?>" style="width:100px;"><?php if ($_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['endtime']==0){?>长期显示<?php }else{ ?><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['endtime'],"%Y-%m-%d");?>
<?php }?></span>
						<span class="list_width" style="width:120px;">
						【<a href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
/mod/id/<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['id'];?>
">修改</a>】
						【<a onclick="return confirm('确定要删除公告<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['title'];?>
吗？')" href="<?php echo $_smarty_tpl->tpl_vars['url']->value;?>
/del/id/<?php echo $_smarty_tpl->tpl_vars['notices']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['id'];?>
">删除</a>】
						</span>
					</li>
					<?php endfor; else: ?>
					<li class="light-row">暂无公告！</li>
					<?php endif; ?>
					<li class="dark-row">
