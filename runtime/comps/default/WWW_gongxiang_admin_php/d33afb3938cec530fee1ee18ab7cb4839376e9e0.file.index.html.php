<?php /* Smarty version Smarty-3.1.8, created on 2016-02-03 14:30:43
         compiled from "./admin/views/default\article\index.html" */ ?>
<?php /*%%SmartyHeaderCode:2325056b19e935fd941-97151602%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd33afb3938cec530fee1ee18ab7cb4839376e9e0' => 
    array (
      0 => './admin/views/default\\article\\index.html',
      1 => 1439819939,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2325056b19e935fd941-97151602',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56b19e9370f049_30325865',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56b19e9370f049_30325865')) {function content_56b19e9370f049_30325865($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'D:\\phpStudy\\WWW\\gongxiang\\php\\libs\\plugins\\modifier.date_format.php';
...
/index/pid/"+pid+"/search/"+sval;
					...
					<li class="dark-row">
						<span class="list_width width_font" style="width:430px">标题</span>
						<span class="list_width width_font" style="width:80px">作&nbsp;&nbsp;者</span>
...
?>
						<li class="<?php if (!(1 & $_smarty_tpl->getVariable('smarty')->value['section']['doc']['index'])){?>light-row<?php }else{ ?>dark-row<?php }?>" style="padding-top:2px; padding-bottom:2px">
							<span class="list_width" style="width:430px"><input type="checkbox" name="id[]" value="<?php echo $_smarty_tpl->tpl_vars['arts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['id'];?>
">&nbsp;<a href="<?php echo $_smarty_tpl->tpl_vars['root']->value;?>
/index.php/article/article/aid/<?php echo $_smarty_tpl->tpl_vars['arts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['id'];?>
" target="_blank"><?php echo $_smarty_tpl->tpl_vars['arts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['title'];?>
</a></span>
							<span class="list_width" style="width:70px"><?php echo $_smarty_tpl->tpl_vars['arts']->value[$_smarty_tpl->getVariable('smarty')->value['section']['doc']['index']]['author'];?>
</span>
